<h2><a href="https://practice.geeksforgeeks.org/problems/maximum-stone-removal-1662179442/1">Maximum Stone Removal</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">There are&nbsp;<strong>n</strong>&nbsp;stones at some integer coordinate points on a 2D plane. Each coordinate point may have at most one stone.</span></p>
